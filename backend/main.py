...
def send_delay_email(flight_number, origin, dest, delay_minutes, reason):
    ...
    msg['Subject'] = f"Update on Flight {flight_number}: Safety & Travel Information"
    
    body = f"""
    <html>
      <body style="font-family: sans-serif; padding: 20px; color: #333;">
        <h2 style="color: #2563eb;">We Prioritize Your Safety & COmfort</h2>
        <p>Dear Passenger,</p>
        <p>To ensure the highest safety standards and respect the well-being of our crew, Flight <strong>{flight_number}</strong> ({origin} &rarr; {dest}) has been flagged for adjustment.</p>
        
        <div style="background: #f3f4f6; padding: 15px; border-radius: 8px; margin: 20px 0;">
            <p><strong>Status Update:</strong> Delayed by approx. {delay_minutes} minutes</p>
            <p><strong>Reason:</strong> {reason}</p>
        </div>

        <p>Our AI Co-Pilot is currently working with our Operations Center to finalize the best resolution for you. We are committed to transparency and will update you the moment a safe path forward is approved by our human operators.</p>
        
        <p style="color: #666; font-size: 0.9em;"><em>Note: This message honors your Right to Information under Industry 5.0 Standards.</em></p>
        <hr>
        <p><em>SkyCoPilot Passenger Rights Team</em></p>
      </body>
    </html>
    """
